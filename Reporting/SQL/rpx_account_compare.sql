alter procedure [dbo].[rpx_account_compare] --rpx_account_compare 199
(	
...
begin
	...
	--select @porfolio_market_value = 1000000
	...
	select 
		...
		case
 		...
 		case
			...
			case 
			    when sector_target.target <> 0 then
			...
			round(((((coalesce(positions.quantity, 0)  
					...
					/(Coalesce(sector_target.target,1) * @porfolio_market_value)), 2)	
			     else 0
				 end
