namespace LinkCash.Client.View
{
   ...
   using LinkCash.Client.ViewModel;
    ...
    public partial class LinkCashVisual : UserControl
    {

        string subPath = "c:\\dashboard";
        string file = "LinkCash.xaml";
        string file2 = "LinkCash2.xaml";
         # region Parameters


        private string getsecurityTextinfo = "";
        private int getsecurityLenthinfo = 0;
        public LinkCashViewerModel _vm;
        ...
        public int BrokerId
        {
         ...
         public LinkCashVisual(LinkCashViewerModel securityHistoryViewerModel)
         {
                ...
                delegate(object eventArg)
                {
                    ...
                    foreach (DataTable table in ds.Tables)
                    {
                        foreach (DataRow row in table.Rows)
                        {
                            ...
                            {
                                cmboDesk.Items.Add(new LinkCash.Client.ComboBoxItem(Convert.ToString(item), Convert.ToInt64(desk_id)));
        ...
        {
            _dataGridLink.RestoreLayoutFromXml(subPath + "\\" + file2);
        }
        ...
        public void SaveXML()
        {
            ...
            if (!exists)
            {
                ...
                _dataGridLink.SaveLayoutToXml(subPath + "\\" + file2);
        ...
        private void cmboDesk_SelectedIndexChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            else
            {
                if (!String.IsNullOrEmpty((cmboDesk.SelectedItem).ToString()))
                {
                    ...
                    DeskId = Convert.ToInt32(((LinkCash.Client.ComboBoxItem)cmboDesk.SelectedItem).HiddenValue);
