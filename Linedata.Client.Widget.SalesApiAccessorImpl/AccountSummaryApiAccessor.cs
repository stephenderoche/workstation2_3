namespace Linedata.Client.Widget.AccountSummaryApiAccessorImpl
{
    ...
    [Export(typeof(IAccountSummaryApiAccessor))]
    public class AccountSummaryApiAccessor : IAccountSummaryApiAccessor
    {
        private static readonly ILog Logger = LogManager.GetLogger(typeof(AccountSummaryApiAccessor));
        ...
        ~AccountSummaryApiAccessor()
        {
            this.Dispose(false);
        }

        public IAccountSummaryNotifier AccountSummaryNotifier { get; private set; }
