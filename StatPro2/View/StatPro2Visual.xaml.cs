namespace StatPro2.Client.View
{
   ...
   using StatPro2.Client.ViewModel;
    ...
    public partial class StatPro2Visual : UserControl
    {
        public StatPro2ViewerModel _view;
        ...
        public StatPro2Visual(StatPro2ViewerModel ViewerModel)
         {
             InitializeComponent();
        ...
        {
            (this.DataContext as StatPro2ViewerModel).SetLoadingState(false);
            (this.DataContext as StatPro2ViewerModel).UrlForTitle = this.webBrowser.Source.ToString();
            (this.DataContext as StatPro2ViewerModel).UpdateTitle();
        }

        private void OnBeginNavigating(object sender, System.Windows.Navigation.NavigatingCancelEventArgs e)
        {
            (this.DataContext as StatPro2ViewerModel).SetLoadingState(true);
        }
